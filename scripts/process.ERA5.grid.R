...
#######################################################################
# After the download, we can restart here

# files <- list.files("./data",pattern = "ERA*",full.names = TRUE)
...
# dewpoint <- ncdf4::ncvar_get(ncdf4::nc_open("./outputs/era5.2m_dewpoint_temperature.nc"), "d2m") # Check units!
# airtemp <- ncdf4::ncvar_get(ncdf4::nc_open("./outputs/era5.2m_temperature.nc"), "t2m")
# pressure <- ncdf4::ncvar_get(ncdf4::nc_open("./outputs/era5.surface_pressure.nc"), "sp")  # Make sure this is in Pa
...
all.lats <- df.mask[["lat"]]
all.lons <- df.mask[["lon"]]
...
# scp /home/femeunier/Documents/projects/YGB/scripts/process.ERA5.grid.R hpc:/data/gent/vo/000/gvo00074/felicien/R
